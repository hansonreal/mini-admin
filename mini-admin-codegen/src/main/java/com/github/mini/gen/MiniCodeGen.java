...
public class MiniCodeGen {
    ...
    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/mini-admin?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
...
// 代码生成器
        ...
        pc.setParent("com.github.mini.system");  //根目录
        pc.setEntity("domain");   //实体目录
        ...
        templateConfig.setService(templateConfig.getService()); //不生成services
